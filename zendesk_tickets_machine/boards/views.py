        ...
        for each in tickets:
            ...
            try:
                ...
                if ticket:
                    ...
                    items = result_details.popitem()
                    for error_item in items[1]:
                        item_description = error_item.get('description')
                        item_error = error_item.get('error')
                        error_text = result_description + ': ' + item_description + ' (' + item_error + ')'
